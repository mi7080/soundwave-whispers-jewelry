...
const AdminCRM = () => {
  ...
  const fetchAll = async () => {
    ...
    const [ordersRes, leadsRes] = await Promise.all([
      supabase.from("animus_orders").select("id, pet_name, customer_name, customer_email, amount, fulfillment_status, soul_page_url, shopify_order_id, created_at").order("created_at", { ascending: false }),
